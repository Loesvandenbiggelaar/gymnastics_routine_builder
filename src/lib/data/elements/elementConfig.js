...
export const apparatusConfig = {
	v_w: { name: m.apparatus_vault(), icon: 'vault.svg', id: 'v_w', sex: m.sex_womens() },
	b: { name: m.apparatus_beam(), icon: 'beam.svg', id: 'b', sex: m.sex_womens() },
	ub: {
	...
	f_w: { name: m.apparatus_floor(), icon: 'floor.svg', id: 'f_w', sex: m.sex_womens() },
	v_m: { name: m.apparatus_vault(), icon: 'vault.svg', id: 'v_m', sex: m.sex_mens() },
	r: { name: 'rings', icon: 'rings.svg', id: 'r', sex: m.sex_mens() },
	ph: {
		name: 'pommel horse',
	...
	hb: { name: 'high bar', icon: 'high_bar.svg', id: 'hb', sex: m.sex_mens() },
	pb: {
		name: 'parallel bars',
	...
	f_m: { name: m.apparatus_floor(), icon: 'floor.svg', id: 'fm', sex: m.sex_mens() }
};
