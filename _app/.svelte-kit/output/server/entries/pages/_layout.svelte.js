import { s as setContext, g as getContext, a as get_store_value, c as create_ssr_component, e as escape, b as add_attribute, d as compute_slots, f as subscribe, h as createEventDispatcher, o as onDestroy, i as spread, j as escape_object, v as validate_component, k as add_classes } from "../../chunks/ssr.js";
...
const Navigation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(AppBar, "AppBar").$$render(
    ...
    {},
    {
      ...
      lead: () => {
        return `<button class="btn variant-filled-primary">${validate_component(Icon, "Icon").$$render(
          $$result,
          {
            icon: "mdi:menu",
      ...
      default: () => {
        return `<button class="btn variant-filled-primary bg-red-500"></button>`;
      }
    }
  )}`;
});
const Drawer_nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $page, $$unsubscribe_page;
  $$unsubscribe_page = subscribe(page, (value) => $page = value);
  $$unsubscribe_page();
  return `<nav class="list-nav"><a href="/"${add_classes(($page.url.pathname === "/" ? "active" : "").trim())} data-svelte-h="svelte-1cyizk9">Home</a> <a href="/about"${add_classes(($page.url.pathname === "/about" ? "active" : "").trim())} data-svelte-h="svelte-i3o4jt">About</a> <a href="/builder"${add_classes(($page.url.pathname === "/builder" ? "active" : "").trim())} data-svelte-h="svelte-1y3jtgj">Builder</a></nav>`;
});
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Navigation, "Navigation").$$render($$result, {}, {}, {})} ${validate_component(Drawer, "Drawer").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(Drawer_nav, "DrawerNav").$$render($$result, {}, {}, {})}`;
    }
  })} ${slots.default ? slots.default({}) : ``} ${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})}`;
});
export {
  Layout as default
};
