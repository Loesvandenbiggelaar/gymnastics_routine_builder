<script lang="ts">
	...
	import { floor_routine_normal, beam_routine_loes, ub_routine_normal_d1, floor_men_routine_h1 } from '$lib/data/test_data/test_routines';
	...
	function processInput() {
		...
		// 'b' = beam
		$data.routineMutations.addElement(getElement('f_m', inputValue));
	}
	...
	onMount(() => {
		$data.routineMutations.routine.set(floor_men_routine_h1);
	});
