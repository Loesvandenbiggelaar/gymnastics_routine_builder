...
// import { flatten_routine as flattenRoutine, is_dismount_done, sort_elements, sliceArray, compareArrayBonus } from './helper_functions.js';
...
//          * @returns {void}
//          */
//         if (this.difficultyCalculated)
//             return;
//         var _nr_acrobatic_elements = nrAcrobatic;
//         var _nr_dance_elements = nrGymnastic;
//         var _total_nr_elements = nrElements - _nr_acrobatic_elements - _nr_dance_elements;
//         var _found_elements = [];
...
//         sort_elements(_acrobatic_elements).map((elementMetadata) => {
...
//         // the elements with the highest value are counted first
//         // if the element is already counted, it is not counted again
//         sort_elements(_dance_elements).map((elementMetadata) => {
//             var _a;
//             if (elementMetadata.isRepeated == false) {
//                 if (_nr_dance_elements > 0) {
//                     _found_elements.push(elementMetadata.element);
//                     _nr_dance_elements -= 1;
//                     this.difficultyElements += (_a = elementMetadata.value) !== null && _a !== void 0 ? _a : elementMetadata.element.value;
//                     elementMetadata.value = elementMetadata.element.value;
...
//         // the elements with the highest value are counted first
//         // if the element is already counted, it is not counted again
//         sort_elements(_other_elements).map((elementMetadata) => {
...
//                 var _slicedElements = sliceArray(_comboElements, comboOption.combo.length);
//                 if (comboOptionSerie.uniqueElements) {
